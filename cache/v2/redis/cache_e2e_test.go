...
func TestCache_e2e_SetNX(t *testing.T) {
	...
	testCase := []struct {
		...
		},
		{
			name: "setnx e2e fail",
			before: func(ctx context.Context, t *testing.T) {
				require.NoError(t, rdb.SetNX(ctx, "testnx", "hello cool_cache", time.Minute).Err())
			},
			after: func(ctx context.Context, t *testing.T) {
...
func TestCache_e2e_GetSet(t *testing.T) {
	...
	testCase := []struct {
	...
	}{
		{
			...
			before: func(ctx context.Context, t *testing.T) {
				require.NoError(t, rdb.Set(context.Background(), "test_get_set", "hello cool_cache", time.Second*10).Err())
			},
			after: func(ctx context.Context, t *testing.T) {
	...
	for _, tc := range testCase {
		t.Run(tc.name, func(t *testing.T) {
			...
			assert.Equal(t, val.Value, tc.wantVal)
			assert.Equal(t, val.Error, tc.wantErr)
			tc.after(ctx, t)
		})
	}
}
...
func TestCache_e2e_LPush(t *testing.T) {
	...
	testCase := []struct {
		...
		},
		{
			...
			before: func(ctx context.Context, t *testing.T) {
				require.NoError(t, rdb.LPush(context.Background(), "test_cache_lpush", "hello cool_cache", "hello go").Err())
			},
			after: func(ctx context.Context, t *testing.T) {
...
func TestCache_e2e_SAdd(t *testing.T) {
	...
	testCase := []struct {
	...
	}{
		{
			...
			key:     "test_e2e_sadd",
			val:     []any{"hello cool_cache", "hello go"},
			wantVal: 2,
		},
		{
...
func TestCache_e2e_SRem(t *testing.T) {
	...
	testCase := []struct {
	...
	}{
		{
			name: "srem e2e value",
			before: func(ctx context.Context, t *testing.T) {
				require.NoError(t, rdb.SAdd(context.Background(), "test_e2e_srem", "hello", "cool_cache").Err())
			},
			after: func(ctx context.Context, t *testing.T) {
		...
		},
		{
			...
			before: func(ctx context.Context, t *testing.T) {
				require.NoError(t, rdb.SAdd(context.Background(), "test_e2e_srem", "hello", "cool_cache").Err())
				require.NoError(t, rdb.SRem(context.Background(), "test_e2e_srem", "hello", "cool_cache").Err())
			},
			after: func(ctx context.Context, t *testing.T) {
...
func TestCache_e2e_IncrBy(t *testing.T) {
	...
	testCase := []struct {
		...
		{
			name: "cool_cache e2e incrby not exists",
			before: func(ctx context.Context, t *testing.T) {
		...
		{
			name: "cool_cache e2e incrby set value",
			before: func(ctx context.Context, t *testing.T) {
...
func TestCache_e2e_DecrBy(t *testing.T) {
	...
	testCase := []struct {
		...
		{
			name: "cool_cache e2e decrby not exists",
			before: func(ctx context.Context, t *testing.T) {
		...
		{
			name: "cool_cache e2e decrby set value",
			before: func(ctx context.Context, t *testing.T) {
...
func TestCache_e2e_IncrByFloat(t *testing.T) {
	...
	testCase := []struct {
		...
		{
			name: "cool_cache e2e incrbyfloat set value",
			before: func(ctx context.Context, t *testing.T) {
		...
		{
			name: "cool_cache e2e incrbyfloat set exponential symbol",
			before: func(ctx context.Context, t *testing.T) {
		...
		{
			name: "cool_cache e2e incrbyfloat set by int",
			before: func(ctx context.Context, t *testing.T) {
		...
		{
			name: "cool_cache e2e incrbyfloat set zero igon",
			before: func(ctx context.Context, t *testing.T) {
