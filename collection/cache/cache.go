...
import (
	...
	"github.com/apus-run/sea-kit/collection/timingwheel"
	"github.com/apus-run/sea-kit/concurrency/sf"
...
func NewCache(expire time.Duration, opts ...CacheOption) (*Cache, error) {
	...
	timingWheel, err := timingwheel.NewTimingWheel(time.Second, slots, func(k, v any) {
		key, ok := k.(string)
		if !ok {
			return
		}
