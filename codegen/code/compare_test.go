...
func TestCompatibleTypes(t *testing.T) {
	valid := []struct {
		...
		{"*[]string", "[]*string"},
		{"*[]*[]*[]string", "[][][]string"},
		{"safemap[string]interface{}", "safemap[string]interface{}"},
		{"safemap[string]string", "safemap[string]string"},
		{"Bar", "Bar"},
		{"interface{}", "interface{}"},
	...
	invalid := []struct {
		...
		{"[]string", "[][]string"},
		{"Bar", "Baz"},
		{"safemap[string]interface{}", "safemap[string]string"},
		{"safemap[string]string", "[]string"},
