...
import (
	...
	collection "github.com/apus-run/sea-kit/collection"
	ginx "github.com/apus-run/sea-kit/ginx"
)
...
func (m *MockSession) Get(ctx context.Context, key string) collection.AnyValue {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, key)
	ret0, _ := ret[0].(collection.AnyValue)
	return ret0
}
...
// Get mocks base method.
func (m *MockProvider) Get(ctx *ginx.Context) (Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockProvider) NewSession(ctx *ginx.Context, uid int64, jwtData map[string]string, sessData map[string]any) (Session, error) {
	m.ctrl.T.Helper()
...
func (m *MockProvider) RenewAccessToken(ctx *ginx.Context) error {
	m.ctrl.T.Helper()
